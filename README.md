...
This repository contains the official implementation of MA-BC for the paper "Split the Differences, Pool the Rest: Provably Efficient Multi-Objective Imitation"
